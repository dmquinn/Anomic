					...
					<div className="container">
						<div className="row justify-content-center pb-5">
							<div className="col-lg-5 mt-5">
								<h5>
									Anomic is a Berlin based record label
									started in 2020. We love noise, rock 'n'
									roll and musicians with soul. Digital and
									physical releases from bands and artists
									around the world.
								</h5>
								<h4 className="mt-5">
